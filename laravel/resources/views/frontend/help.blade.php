	...
	<div class="splace-portrait">
		<div class="splace-article-header" style="background-image: linear-gradient(-60deg, rgb(73,137,124), rgb(112,198,215));">
			...
			<div class="splace-article-header__help-wrapper">
				<div class="splace-article-header__help-row">
					...
					<g>
						...
						<path fill="#FFFFFF" d="M31.586,61.996c0,0-0.184-0.188-0.226-0.448s-0.006-0.469-0.006-0.469s-0.254-0.021-0.538-0.182
							...
							<rect x="10.977" y="41.504" transform="matrix(-0.9877 -0.1565 0.1565 -0.9877 50.7915 113.3759)" fill="none" width="37.762" height="26.371"/>
						<g>
							<defs>
				...
				<div class="splace-article-header__help-row">
					...
					<span><b>Swipe</b> to next Article</span>
				</div>
				<div class="splace-article-header__help-row">
					<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 70" enable-background="new 0 0 60 70" xml:space="preserve">
					<g>
					...
					<span><b>Scroll</b> down to read</span>
				</div>
				<div class="splace-article-header__help-row">
					<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 70" enable-background="new 0 0 60 70" xml:space="preserve">
					<g>
		...
		<div class="splace-paragraph splace-grid-row splace-grid-3">
			<div class="splace-grid-item splace-help-box">
				<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 109.298 169.771" enable-background="new 0 0 109.298 169.771" xml:space="preserve" width="109.298px" height="169.771px">
				<g>
					<defs>
						<rect id="SVGID_53_" width="109.298" height="169.771"/>
					</defs>
					<clipPath id="SVGID_2_">
						<use xlink:href="#SVGID_53_"  overflow="visible"/>
					</clipPath>
					<path clip-path="url(#SVGID_2_)" fill="none" stroke="#ACABAB" stroke-width="0.781" stroke-miterlimit="10" d="M102.539,0.39
						H6.759c-3.515,0-6.368,2.856-6.368,6.368v136.474c0,3.512,2.854,6.367,6.368,6.367h95.78c3.511,0,6.368-2.855,6.368-6.367V6.758
						C108.907,3.246,106.05,0.39,102.539,0.39z"/>
				</g>
				<rect x="8.868" y="12.259" fill="none" stroke="#ACABAB" stroke-width="0.781" stroke-miterlimit="10" width="91.561" height="118.69"/>
				<g>
					<defs>
						<rect id="SVGID_55_" width="109.298" height="169.771"/>
					</defs>
					<clipPath id="SVGID_4_">
						<use xlink:href="#SVGID_55_"  overflow="visible"/>
					</clipPath>
					<path clip-path="url(#SVGID_4_)" fill="none" stroke="#ACABAB" stroke-width="0.781" stroke-miterlimit="10" d="M54.648,141.971
						c-1.872,0-3.391-1.516-3.391-3.391c0-1.877,1.519-3.391,3.391-3.391c1.873,0,3.392,1.514,3.392,3.391
						C58.04,140.455,56.521,141.971,54.648,141.971z"/>
				</g>
				<g>
					<defs>
						<path id="SVGID_57_" d="M84.475,83.029l-0.084,0.113c0.029-0.037,0.058-0.076,0.086-0.113H84.475z"/>
					</defs>
					<clipPath id="SVGID_6_">
					...
					<g clip-path="url(#SVGID_6_)">
						<defs>
							<rect id="SVGID_59_" x="83.891" y="82.254" width="1.439" height="1.441"/>
						</defs>
						<clipPath id="SVGID_8_">
							<use xlink:href="#SVGID_59_"  overflow="visible"/>
						</clipPath>
						<g transform="matrix(1 0 0 1 7.629395e-06 0)" clip-path="url(#SVGID_8_)">
							
								<image overflow="visible" width="3" height="3" xlink:href="data:image/jpeg;base64,/9j/4AAQSkZJRgABAgEAlgCWAAD/7AARRHVja3kAAQAEAAAAHgAA/+4AIUFkb2JlAGTAAAAAAQMA
				EAMCAwYAAAFzAAABgAAAAan/2wCEABALCwsMCxAMDBAXDw0PFxsUEBAUGx8XFxcXFx8eFxoaGhoX
				...
				ABMEFBEAAgAHAAAAAAAAAAAAAAAAERIAAVECMhMUEgEAAAAAAAAAAAAAAAAAAAAA/9oADAMBAAIR
				AxEAAACvB//aAAgBAgABBQB//9oACAEDAAEFAH//2gAIAQEAAQUAhv5//9oACAECAgY/AH//2gAI
				AQMCBj8Af//aAAgBAQEGPwBeiexy63Y0Aj//2Q==" transform="matrix(0.48 0 0 -0.48 83.8906 83.6953)">
							</image>
						</g>
					</g>
				</g>
				<polygon fill="#E40A33" points="74.449,75.016 63.489,66.016 63.489,73.016 34.849,73.016 34.849,77.016 63.489,77.016 
					63.489,83.977 "/>
				<g>
					<defs>
						<rect id="SVGID_61_" width="109.298" height="169.771"/>
					</defs>
					<clipPath id="SVGID_10_">
						<use xlink:href="#SVGID_61_"  overflow="visible"/>
					</clipPath>
					<path clip-path="url(#SVGID_10_)" fill="#C2B9B9" d="M51.947,122.383c0,0,0.532-1.047,1.164-1.881
						c1.176-1.553,3.097-4.029,4.879-7.346c2.153-4.014,2.668-5.635,5.182-8.043c1.788-1.711,9.865-12.094,12.082-15.24
						c2.578-3.656,7.14-8.967,8.499-9.766c3.145-1.85,5.006-0.932,6.356,1.645c0.375,0.721,0.247,1.506-0.199,2.73
						c-0.651,1.764-1.289,2.369-2.435,3.926c-1.653,2.25-4.222,5.258-4.67,6.137c-1.367,2.695-9.511,14.428-9.511,14.428
						s6.818-7.734,11.015-6.68c2.356,0.867,4.588,2.15,4.769,3.814c0.348,3.219,0,5.721,0,5.721s2.86,0.141,3.815,2.863
						c0.953,2.721-0.604,7.557-0.604,7.557s1.668,0.711,2.358,3.014c0.691,2.303,0.614,6.334,0.755,7.34
						c0.277,2.01,0.316,0.75,0.237,2.17c-0.021,0.352,0.037,2.064-0.899,4.246c-2.836,6.588-9.205,18.723-9.64,20.885
						c-0.16,0.793,0.193,2.051,0.097,2.682c-0.248,1.652-0.734,2.195-0.386,2.682c0.482,0.672-0.067,0.582-0.502,1.879
						c-0.434,1.291-28.811,6.137-32.425-1.908c-1.215-2.707-1.622-6.963-3.355-10.268c-0.937-1.781-4.285-6.059-7.084-12.357
						c-2.395-5.387-4.255-12.91-4.48-14.496c-0.36-2.51,1.546-6.045,2.601-9.932c0.88-3.24,1.657-6.809,2.505-7.471
						c2.7-2.113,5.025-2.482,5.025-2.482s0.779-0.67,1.081-0.771c0.305-0.1,2.228-3.891,4.42-3.99c1.252-0.059,2.26,0.838,2.7,3.084
						c0.127,0.645,0.13,1.955-0.1,3.289c-0.25,1.432-1.479,2.863-2.404,4.404c-1.202,1.996-2.827,2.475-2.817,2.352
						c-0.104,0.658,0.74,1.264,0.28,2.83c-0.477,1.615-1.079,1.184-1.233,1.938c0,0,1.382-0.27,1.907,0
						C51.384,121.6,51.947,122.383,51.947,122.383"/>
					
						<path clip-path="url(#SVGID_10_)" fill="none" stroke="#FFFFFF" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="
						M75.17,113.264c0,0,5.585-4.418,6.5-6.793 M92.967,121.832c-0.673,2.451-3.533,7.328-4.194,8.402 M89.573,110.945
						c0,0-0.389,5.15-5.162,11.303"/>
				</g>
				</svg>
				<p>
			...
			<div class="splace-grid-item splace-help-box">
				<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" width="109.298px" height="169.771px" y="0px" viewBox="0 0 109.298 169.771" enable-background="new 0 0 109.298 169.771" xml:space="preserve">
				<g>
					<defs>
			...
			<div class="splace-grid-item splace-help-box">
				<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="109.298px" height="169.771px" viewBox="0 0 109.298 169.771" enable-background="new 0 0 109.298 169.771" xml:space="preserve">
				<g>
					<defs>
				...
				<g>
					<defs>
							...
							<rect id="SVGID_77_" x="21.837" y="116.945" transform="matrix(-0.6157 -0.788 0.788 -0.6157 -10.7232 289.1596)" width="86.635" height="60.5"/>
					</defs>
					<clipPath id="SVGID_8_">
		...
		<div class="splace-paragraph">
			<div class="splace-help-box">
				...
				<p>
					Bei splace handelt es sich um zwei Magazine in einem: Je nachdem, ob das Tab- let senkrecht oder waagrecht gehalten wird, eröffnen sich unterschiedliche Ver- sionen der Beiträge. Die vertikale Variante lädt Sie ein Artikel zu unterschiedli- chen Aspekten des Raums zu lesen und ihr Wissen zu vertiefen. Die horizontale
				</p>
			</div>
		</div>
	</div>
