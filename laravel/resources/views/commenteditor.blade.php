			...
			<div class="panel panel-default">
				...
				<div class="panel-body editor">
					<form class="comment-editor-form" method="post" >
						...
						<div class="form-group">
							<h4>Kommentar</h4>
							<textarea class="form-control comment-text-area" name="text" disabled="disabled" placeholder="Text" >{{ $comment->text or '' }}</textarea>	
						</div>

						<div class="form-group">
							Veröffentlichen 
							<input type="checkbox" name="marked" @if($comment->marked == '1') checked @endif />
						</div>
